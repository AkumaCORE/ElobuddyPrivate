...
/*
 ...
 Interrupter2.cs is part of EloBuddy.Common.
...
namespace EloBuddy.Common
{
    ...
    public static class Interrupter2
    {
        ...
        private static void Spellbook_OnStopCast(Obj_AI_Base objAiBase, SpellbookStopCastEventArgs args)
        {
            var target = objAiBase as AIHeroClient;
            if (target != null)
            {
