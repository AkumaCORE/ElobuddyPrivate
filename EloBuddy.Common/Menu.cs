...
/*
 ...
 Menu.cs is part of EloBuddy.Common.
...
using EloBuddy;
using EloBuddy.Common.Properties;
using SharpDX;
...
namespace EloBuddy.Common
{
    ...
    internal class CommonMenu
    {
        ...
        /// The configuration
        /// </summary>
        internal static Menu Config = new Menu("EloBuddy.Common", "EloBuddy.Common", true);
    ...
    public class Menu
    {
        ...
        static Menu()
        {
            ...
            root.AddItem(
                new MenuItem("EloBuddy.Common.TooltipDuration", "Tooltip Notification Duration").SetValue(
    ...
    public class MenuItem
    {
        ...
        public int TooltipDuration
        {
            get
            {
                return CommonMenu.Config.Item("EloBuddy.Common.TooltipDuration").GetValue<Slider>().Value;
            }
        }
