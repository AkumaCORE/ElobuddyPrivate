...
/*
 ...
 MultiLanguage.cs is part of EloBuddy.Common.
...
namespace EloBuddy.Common
{
    ...
    public static class MultiLanguage
    {
        ...
        public static bool LoadLanguage(string languageName)
        {
            try
            {
                var languageStrings = new ResourceManager("EloBuddy.Common.Properties.Resources", typeof(Resources).Assembly).GetString(languageName + "Json");
