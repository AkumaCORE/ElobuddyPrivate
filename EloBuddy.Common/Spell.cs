...
/*
 ...
 Spell.cs is part of EloBuddy.Common.
...
namespace EloBuddy.Common
{
    ...
    public class Spell
    {
        ...
        void Spellbook_OnUpdateChargedSpell(Spellbook sender, SpellbookUpdateChargeableSpellEventArgs spellbookUpdateChargeableSpellEventArgs)
        {
            if (sender.Owner.IsMe && Utils.TickCount - _chargedReqSentT < 3000)
            {
                spellbookUpdateChargeableSpellEventArgs.Process = false;
            }
        }
        ...
        {
            get { return Player.Instance.Spellbook.GetSpell(Slot).SData.ManaCostArray[Player.Instance.Spellbook.GetSpell(Slot).Level]; }
        }
