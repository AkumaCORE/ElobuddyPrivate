...
/*
 ...
 Orbwalking.cs is part of EloBuddy.Common.
...
namespace EloBuddy.Common
{
    ...
    public static class Orbwalking
    {
        ...
        {
            if (AfterAttack != null && Utility.IsValidTarget(target))
            {
                    ...
                    if (!ShouldWait())
                    {
                        ...
                        result = (from minion in
                                      ObjectManager.Get<Obj_AI_Minion>()
                                          ...
                                          (_config.Item("AttackWards").GetValue<bool>() || !MinionManager.IsWard(minion.BaseSkinName.ToLower())) &&
                                          (_config.Item("AttackPetsnTraps").GetValue<bool>() && minion.BaseSkinName != "jarvanivstandard" || MinionManager.IsMinion(minion, _config.Item("AttackWards").GetValue<bool>())) &&
