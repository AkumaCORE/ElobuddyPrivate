...
namespace BRSelector.External
{
    public partial class Menu : Form
    {
        ...
        private void showTarget_CheckedChanged(object sender, System.EventArgs e)
        {
            Misc.SetChecked(Selector.DrawMenu, "drawTarget", showTarget.Checked);
        }

        private void selectorType_SelectedIndexChanged(object sender, System.EventArgs e)
        {
            Misc.SetSliderValue(Selector.SelectorMenu, "selectorType", selectorType.SelectedIndex);
        }

        private void forceSelectedTarget_CheckedChanged(object sender, System.EventArgs e)
        {
            Misc.SetChecked(Selector.SelectorMenu, "forceTarget", forceSelectedTarget.Checked);
        }

        private void drawForcedTarget_CheckedChanged(object sender, System.EventArgs e)
        {
